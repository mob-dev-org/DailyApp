...
//             const { getByTestId } = render(<Button label="test" testID="button" border />);
...
//             const { getByText } = render(<Button label="test" testID="button" uppercase />);
//                 expect(getByText('test')).toHaveStyle({
...
//             const { getByTestId } = render(<Button label="test" testID="button" size="large" />);
//                 expect(getByTestId('button')).toHaveStyle({
//             padding: 16,
...
//             const { getByTestId, getByText } = render(<Button label="test" testID="button" size="small" />);
